...
//private final String RESULT_SEARCH_PAGE = "search.jsp";
    private final String RESULT_SEARCH_PAGE = "searchPage";
...
//        String url = siteMaps.getProperty(RESULT_SEARCH_PAGE);
        String error = (String)request.getParameter("CREATE_ERROR");
